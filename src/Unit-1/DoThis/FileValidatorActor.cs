		...
		protected override void OnReceive(object message)
		{
            ...
            else
            {
                ...
                if (valid)
                {
					...
					var tell = new TailCoordinatorActor.StartTail(msg, _consoleWriterActor);
					
					Context.ActorSelection("akka://actorsystem/user/tailcoordinator").Tell(tell);
